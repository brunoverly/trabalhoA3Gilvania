...
public class EditItemControler {
    @FXML private Button editItemConfirmar;
    @FXML private Button editItemCancelar;



    public void editItemCancelarOnAction(ActionEvent event){
        Stage stage = (Stage) editItemCancelar.getScene().getWindow();
        stage.close();
    }
    public void editItemConfirmarOnAction(ActionEvent event){
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
        alert.setTitle("Confirmação");
        alert.setHeaderText(null);
        alert.setContentText("Confirmar a edicao do item?");
